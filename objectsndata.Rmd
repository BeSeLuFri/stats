...
Example:
```{r eval=FALSE}
a=read.csv2("data/SOEP.csv") # reads a csv file saved in the data folder. The file is named SOEP.csv
# everything behind a # (Hashtag) is not run by R.
...
```
***
### Logical Operators and Lobical Vectors
